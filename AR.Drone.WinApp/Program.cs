        ...
        private static void Main()
        {
            switch (Environment.OSVersion.Platform)
            {
                ...
                case PlatformID.Win32Windows:
                    //string ffmpegPath = string.Format(@"../../../../FFmpeg.AutoGen/FFmpeg/bin/{0}", Environment.Is64BitProcess ? "x64" : "x86");
                    string ffmpegPath = string.Format(@"C:/FFmpeg/bin/{0}", Environment.Is64BitProcess ? "x64" : "x86");
